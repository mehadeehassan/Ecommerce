            ...
            <div className="container mx-auto px-4">
                ...
                {/* Services Section */}
                    ...
                    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        ...
                        <AboutCard aboutSection={{ title: "Best Support", description: "Our support team is always there for you whenever you need help.", icon: "🤝" }} />
                        <AboutCard aboutSection={{ title: "Call Us", description: "We are available 24/7 for you.", icon: "📞" }} />
                        <AboutCard aboutSection={{ title: "Free Shipping", description: "We provide free shipping on all orders over $100.", icon: "🚚" }} />
                        <AboutCard aboutSection={{ title: "Secure Payment", description: "We accept all major credit cards and debit cards.", icon: "💳" }} />
                    </div>
