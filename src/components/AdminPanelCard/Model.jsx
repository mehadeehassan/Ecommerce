...
const Model = ({ isOpen, onClose, title, children, footerBtnText, icon: Icon, onConfirm }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="bg-gray-100 w-full max-w-md rounded-xl shadow-2xl overflow-hidden duration-200">
        <div className="flex items-center justify-between p-6">
          ...
          <button onClick={onClose} className="text-red-500 hover:bg-red-50 p-1 rounded-full transition-colors">
