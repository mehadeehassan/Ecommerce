...
const CartRow = ({
  ...
  return (
    <div className="w-full lg:w-2/3 items-center ">
          ...
          <div className="flex items-center justify-center md:justify-between gap-3 mt-6 border-b border-b-gray-200 flex-col md:flex-row p-2 py-4 md:py-2 bg-gray-100 shadow-sm rounded-xl">
            <div className="flex flex-col md:flex-row items-center gap-6 mt-3 md:mt-0">
              <MdOutlineClose
                ...
                className="text-xl text-gray-600 hover:text-orange-500 cursor-pointer duration-300 ml-2"
              />
              <img
            ...
            <div className="flex items-center gap-6 border px-4 py-2">
              ...
              <div className="flex items-center gap-4 text-sm font-semibold">
                <span
                  onClick={() => decreaseQty(product.code)}
                  className="hover:bg-orange-400 hover:text-white px-2 rounded-full duration-500 cursor-pointer"
                >
                  -
                </span>
                {product.quantity}
                <span
                  onClick={() => increaseQty(product.code)}
                  className="hover:bg-orange-400 hover:text-white px-2 rounded-full duration-500 cursor-pointer"
                >
                  +
                </span>
      ...
      <button
        onClick={resetCart}
        className="bg-orange-500 w-full text-white mt-8 py-1 px-6 hover:bg-orange-600 rounded"
      >
        Reset Cart
      </button>
