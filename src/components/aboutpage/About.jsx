    ...
    return (
        <div className="bg-white text-gray-900">
            ...
            <div className="text-center py-20 px-6 bg-gray-50 shadow-md ">
                ...
                <p className="text-gray-400 max-w-2xl mx-auto text-lg hover:text-orange-400 "> We believe in quality and trust. Our main goal is to make your shopping experience easy and enjoyable.</p>
            </div>
